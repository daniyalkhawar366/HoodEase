...
exports.getRelatedProducts = exports.getProductBySlug = exports.getProductsByCategory = exports.products = void 0;
exports.products = [
    {
        id: '1',
...
const getProductsByCategory = (category) => exports.products.filter(product => product.category === category);
exports.getProductsByCategory = getProductsByCategory;
const getProductBySlug = (slug) => exports.products.find(product => product.slug === slug);
exports.getProductBySlug = getProductBySlug;
const getRelatedProducts = (currentProduct, limit = 4) => exports.products
